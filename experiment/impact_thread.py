...
def impact_thread(datset, indice, num_threads_list):
  # from function import plot_qps_recall_curve
  k = 10
  perf_output = "perf/factor/thread"
  figure_output = "figure/factor"
  pf_bp = {
...
for dataset in datasets:
  for index in indices:
    impact_thread(dataset, index, [48, 12, 3])