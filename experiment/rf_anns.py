...
for dataset in datasets:
    ...
    os.system(f"""
    ./RF-ANNS/iRangeGraph/build/tests/search \
        --data_path ../data/{dataset}.train.fbin \
        ...
        --index_file ../data/{dataset}.iRangeGraph.index \
        --result_saveprefix perf/rf_anns/{dataset}.iRangeGraph.result \
        --M {M}
    """)
...
for dataset in datasets:
    ...
    os.system(f"""
    ./RF-ANNS/SeRF/build/benchmark/serf_arbitrary \
              -N 10000 \
              -dataset_path ../data/{dataset}.train.fvecs \
              -query_path ../data/{dataset}.test.fvecs
    """)